...
def inicializarVariables(codigo, password):
    ...
    chromedriver_path = 'C:\Users\ariel\OneDrive\Escritorio\CursoPython_Final\Clase6\chromedriver.exe'
...
def registrar_evento(matricula, direccion):
    try:
        ...
        query = """INSERT INTO historial (matricula, direccion, fecha)
                   VALUES (%s, %s, %s)"""
...
if __name__ == '__main__':
    ...
    codigo = input("Ingresar matricula: ")
